...
class BugNameProvider(private val appLocaleManager: AppLocaleManager) {
    private var nameMap: Map<String, BugTranslation> = emptyMap()
    ...
    suspend fun load() {
        ...
        try {
            ...
            val items = json.decodeFromString<List<BugTranslation>>(jsonString)
    ...
    @Serializable
    private data class BugTranslation(
    ...
    companion object {
        private const val VILLAGERS_JSON_PATH = "files/translate/bugs.json"
